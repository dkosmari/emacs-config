...
(defun insert-spdx-apache ()
  "Insert SPDX-License-Identifier header for Apache-2.0 license."
  (interactive)
  (insert-file-contents "~/.emacs.d/insert/spdx-apache.h"))
